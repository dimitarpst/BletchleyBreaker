...
namespace BletchleyBreaker.Web.Data.Migrations
{
    ...
    [Migration("20250321090131_CreateModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BletchleyBreaker.Web.Models.GameSession", b =>
                {
            ...
            modelBuilder.Entity("BletchleyBreaker.Web.Models.Guess", b =>
                {
                    ...
                    b.Property<int>("CorrectNumbers")
                        .HasColumnType("int");

                    b.Property<int>("CorrectPositions")
                        .HasColumnType("int");

                    b.Property<int>("GameSessionId")
                        .HasColumnType("int");

                    b.Property<string>("GuessedCoordinates")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BletchleyBreaker.Web.Models.Player", b =>
                {
                    b.Property<int>("PlayerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BletchleyBreaker.Web.Models.Guess", b =>
                {
                    b.HasOne("BletchleyBreaker.Web.Models.GameSession", null)
                        .WithMany("Guesses")
